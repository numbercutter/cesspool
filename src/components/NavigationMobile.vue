  ...
  <header :class="{ 'scrolled-nav': scrolledNav }" class="p-shadow-4">
   <nav >
     <ul v-show="!mobile" class="navigation ">
        ...
        <li><router-link :to="{ name: 'Marketplace' }" class="link">Marketplace</router-link></li>
     ...
     <transition name="mobile-nav">
       <ul v-show="mobileNav" class="dropdown-nav">
          ...
          <li @click="toggleMobileNav"><router-link :to="{ name: 'Marketplace' }" class="link">Marketplace</router-link></li>
